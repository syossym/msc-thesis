...
Laser.beam_radius = 0.02058;
Laser.wavefront_radius = -1724;

Laser.power = 1; 
Laser.amplitude = sqrt(Laser.power*2/(pi*Laser.beam_radius^2)); % Amplitude for TEM00 input beam

Sidebands.frequency = 10E6;         % Frequency of the sidebands in Hertz
Sidebands.modulation = 0.4;


% New field amplitude
Laser.amplitude = Laser.amplitude * besselj(0,Sidebands.modulation);
Sidebands.amplitude = besselj(1,Sidebands.modulation);              % Amplitude for one of the 2 sidebands
