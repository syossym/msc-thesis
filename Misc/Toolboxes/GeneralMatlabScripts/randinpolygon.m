...
%--------------------------------------------------------------------------------------
% randinpolygon function       Generate random positions inside (or on boundry)  
%                            a polygon, on a plane or a sphere.
% Input  : - Polygon boundries [X, Y] (in case of spherical geometry [long, lat]
%            in radians.
%            Note you must connect also the first and last point!
%          - Number of random points to generate.
%          - Geometry:
%            'plane'    - polygon on a plane (default).
%            'sphere'   - polygin on a sphere. In that case the [X,Y] coordinates
%                         must be in radians.
