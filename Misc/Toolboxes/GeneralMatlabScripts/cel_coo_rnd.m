...
%----------------------------------------------------------------
% cel_coo_rnd function     Generate random coordinates on
%                        the celestial sphere. The program can
%                        applay matrix rotation reject
%                        coordinates, and generate non uniform
%                        coordinates. [preliminary version].
