...
%--------------------------------------------------------------------------
% jackknife function       Given an estimator (given by a function)
%                        calculate the Jackknife StD and the first order
%                        Quenouille-Tukey jacknife bias for
%                        this estimator.
%                        Notes: - the estimator should be continues.
%                               - if Bias/StD~<0.25 then the bias
%                                 is probably not an issue.
%                               - The bias estimate is breaks down if the
%                                 estimator is an unsmooth statistic like
%                                 the median.
