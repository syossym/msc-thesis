...
add_qbox([2200 2800],10,2,GE+HH+LH);          %model the qunatum region with 10 A resolution
...
add_pbox([2200 2800],CB+VB);               %screen output, zoom into the quantum region
                                        %conduction band only, this will also output
                                        %the sheet density of electrons in the channel
add_pbox([0 3000],CB+VB);                  %screen output, overview of the whole structure
