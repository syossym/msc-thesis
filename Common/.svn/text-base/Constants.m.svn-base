...
Consts.c = 2.99792458e8;   3e8;          % light velocity in m/s
Consts.e_0 = 1.60217653e-19; % 1.602e-19;         % elementary charge in As
...
Consts.hbar = Consts.h_J/(2*pi);  1.0546e-34;    % Planck's constant divided by 2*pi in Js
